# adapted from se_resnet101, increased size of sub-blocks to respect architecture
...
def Se_ResNet152(shape = (256, 256, 3), classes = 10):
    # setup input layer
    ...
    model = tf.keras.models.Model(inputs = x_input, outputs = x, name = "Se_ResNet152")
    return model