# adapted from se_resnet34, added a third layer in identity and convolutional block to respect architecture
...
def Se_ResNet50(shape = (256, 256, 3), classes = 10):
    # setup input layer
    ...
    model = tf.keras.models.Model(inputs = x_input, outputs = x, name = "Se_ResNet50")
    return model